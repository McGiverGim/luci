...
var HearingMap = form.DummyValue.extend({
	renderWidget: function () {
		...
		for (var mac in Clients) {
			...
			var client_table = E('table', {'class': 'table cbi-section-table','id':'client_table'+mac}, [
...
return view.extend({
	...
	render: function (data) {
		...
		o.value('0', _('0 Fatal'));
		o.value('1', _('1 Info'));
		o.value('2', _('2 Verbose'));
		o.value('3', _('3 Some debug'));
		o.value('4', _('4 Network packet info'));
		o.value('5', _('5 All debug messages'));
		o.rmempty = false;
		o.editable = true;
